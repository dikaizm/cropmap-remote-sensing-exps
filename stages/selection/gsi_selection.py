...
from stages.selection._utils import (
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="GSI-direct band selection")
    ...
    out_stem   = args.out_stem or f"select_gsi_direct_s{args.score_threshold:g}"
    run_gsi_direct(
        years_data,
